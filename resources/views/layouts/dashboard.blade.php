...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<!-- fbsg-signature-LinkhrefModel -->
            <!-- fbsg-signature-addLiHrefModel:<begin> task -->
            <hr class="sidebar-divider">
            <li class="nav-item"><a class="nav-link" href="/task"><span>task</span></a></li>
            <!-- fbsg-signature-addLiHrefModel:<end>, task -->
                        ...
                        @guest
                            <li class="nav-item no-arrow">
                                <a class="nav-link" href="{{ route('login') }}" role="button" aria-haspopup="true"
                                    aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Log In
                                </a>
                            </li>
                            <li class="nav-item no-arrow">
                                <a class="nav-link" href="{{ route('register') }}" role="button" aria-haspopup="true"
                                    aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Register
                                </a>
                            </li>
                        @else
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true"
                                    aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">{{ Auth::user()->name }}</span> <i class="fa fa-caret-down"></i>
                                </a>
    ...
    @yield('extrascript')
	<!-- fbsg-signature-JSIncludeModel -->
    <!-- fbsg-signature-addJSIncludeModel:<begin> task -->
    <script src="/js/task.js"></script>
    <!-- fbsg-signature-addJSIncludeModel:<end>, task -->
</body>
